            ...
            <table border={0} cellPadding={0} cellSpacing={0} style={{ borderCollapse: 'collapse', width: '800px', height: '142px' }}>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colSpan={2} style={{ paddingTop: '1px', paddingRight: '1px', paddingLeft: '1px', fontFamily: '"맑은 고딕", monospace', verticalAlign: 'middle', fontSize: '10pt', textAlign: 'center', borderTop: '1px solid windowtext', borderRight: '1px solid windowtext', borderBottom: '1px solid windowtext', borderImage: 'initial', borderLeft: 'none', width: '200px' }} className="dext_table_border_l">
                        ...
                        <td colSpan={9} style={{ paddingTop: '1px', paddingRight: '1px', paddingLeft: '1px', fontFamily: '"맑은 고딕", monospace', verticalAlign: 'middle', fontSize: '10pt', textAlign: 'center', borderTop: '1px solid windowtext', borderRight: '1px solid windowtext', borderBottom: '1px solid windowtext', borderImage: 'initial', borderLeft: 'none', width: '242px' }} className="dext_table_border_l">
                            <p style={{ fontFamily: '"맑은 고딕", monospace', fontSize: '10pt', lineHeight: '20px', marginTop: '0px', marginBottom: '0px' }}>
                                <span unselectable="on" contentEditable="false" className="comp_wrap" data-cid={6} data-dsl="{{text}}" data-wrapper style={{ width: '100%', fontFamily: '"맑은 고딕", monospace', fontSize: '10pt' }} data-value data-autotype><input className="ipt_editor" type="hidden" name="sum"/>{dto.sum}</span>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colSpan={12} style={{ paddingTop: '1px', paddingRight: '1px', paddingLeft: '1px', fontFamily: '"맑은 고딕", monospace', verticalAlign: 'top', fontSize: '10pt', textAlign: 'center', borderTop: '1px solid windowtext', borderRight: '1px solid windowtext', borderBottom: '1px solid windowtext', borderImage: 'initial', borderLeft: 'none', width: '300px', height: '51px', backgroundRepeat: 'no-repeat' }} className="dext_table_border_l">
                            <p style={{ fontFamily: '"맑은 고딕", monospace', fontSize: '10pt', lineHeight: '20px', marginTop: '0px', marginBottom: '0px' }}>
                                <span unselectable="on" contentEditable="false" className="comp_wrap" data-cid={8} data-dsl="{{textarea}}" data-wrapper style={{ width: '100%', fontFamily: '"맑은 고딕", monospace', fontSize: '10pt' }} data-value data-autotype><textarea className="txta_editor" cols={83} rows={10} style={{ marginLeft: '-6px', marginTop: '3px', marginBottom: '3px', borderWidth: 0 }} name="content" defaultValue={""} readOnly="true" value={dto.content} /></span>
                            </p>
                        </td>
                    </tr>
...
export default ExpenseEditRead;